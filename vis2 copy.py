...
def main(model,model2=None,datalo=None):
    ...
    class MainApplication(tk.Frame):
        ...
        def draw_new_view(self, event=None):
            ...
            new_state.light_dir = f2l[int(new_state.idx), int(new_state.location[0]*512), int(new_state.location[1]*512)]
            new_state.camera_dir = f2camera[int(new_state.idx),int(new_state.location[0]*512),int(new_state.location[1]*512)]
