...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, item_id):
        ...
        if "ground_rough" in dataset.keys():
            ground_rough = convert_buffer((dataset["ground_rough"][item_id, ...]))
        else:
            ground_rough = None
            #print("no rough mode")
        ...
        if self.get_rays_buffer:
            ...
            buffer.rough = get_numpy(ground_rough)
        ...
        #print("dsad",base_radius)
        #print("ssdd",ground_rough)
        #if ground_rough is None:
        #    ground_rough = 1 / ground_color.shape[-1] / 2
        #print("dsad",ground_rough)
        if ground_rough is None:
            return input, ground_color, location, camera_query_radius, base_radius
        else:
            return input, ground_color, location, camera_query_radius, base_radius, ground_rough
