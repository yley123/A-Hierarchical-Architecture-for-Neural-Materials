...
class BRDFviewer:
    def __init__(self, model,model2, use_pathguiding,datalodar):
    ...
    def eval(self, new_state, brightness, brightness_pg):
                ...
                if self.model2!=None:
                    if self.model2.num_ch_total == 12:
                        result2,eval_output2=self.model2.evaluate(input, location,rough=roughness, level_id=mipmap_level_id, mimpap_type=mimpap_type,
                                         camera_dir=list(camera_dir))
                    if self.model2.num_ch_total == 11:
        ...
        return result, prob_result,result2
    ...
    class MainApplication(tk.Frame):
        ...
        def draw_new_view(self, event=None):
            ...
            if new_state.raw_buffer != -1:
                ...
                new_view, probability_view,new_view2 = brdf_viewer.eval(new_state, self.brightness_b.get(), self.brightness_pg_b.get())
