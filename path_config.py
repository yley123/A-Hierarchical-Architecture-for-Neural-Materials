...
class Config:
    def __init__(self, hostname):
        ...
        if hostname=="default_config":
            path_base = "/mnt/iusers01/fatpou01/compsci01/v67771bx/scratch/code"
            #path_base = "~/scratch/code"
        else:
            assert False
        ...
        self.path_dataset_pbrt = os.path.join(path_base, "datasets_pbrt")#use pbrt (a rederer)
        ...
        self.path_ubo2014 = os.path.join(path_base, "ubo2014")#a dataset name
